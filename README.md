...
Agent 从 Demo 到生产的差距不在模型能力，而在模型之外的工程层——沙箱、工具、上下文、编排、观测、评估、治理。一个 10 步任务，即使单步成功率 95%，端到端也只有 60%（Lusser 定律）。本书将 **ETCLOVG 七层架构**，概念组织成可逐层施工、逐层验收的体系，回答一个问题：**怎么让 Agent 可靠地跑完任务**。
